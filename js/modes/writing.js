    ...
    function renderPrompt() {
      ...
      container.innerHTML = `
        <div class="text-center py-8 px-4 flex flex-col items-center">
          ...
          <button class="w-20 h-20 rounded-full bg-accent text-white text-3xl flex items-center justify-center mb-6 active:scale-95 transition-transform shadow-card" id="writing-replay">&#x1f50a;</button>
          ...
          <button class="min-w-[200px] min-h-[56px] px-8 py-4 rounded-3xl bg-surface2 text-txt text-lg font-semibold active:scale-95 transition-transform shadow-card-sm" id="writing-reveal">Show Answer</button>
        </div>
      `;
      ...
      container.innerHTML = `
        <div class="text-center py-8 px-4 flex flex-col items-center">
          ...
          <div class="flex gap-4 justify-center">
            <button class="min-w-[44px] min-h-[44px] px-6 py-3 rounded-3xl bg-red text-white font-semibold active:scale-95 transition-transform shadow-card" id="writing-wrong">Practice more</button>
            <button class="min-w-[44px] min-h-[44px] px-6 py-3 rounded-3xl bg-green text-white font-semibold active:scale-95 transition-transform shadow-card" id="writing-correct">Got it!</button>
          </div>
        </div>
      `;
