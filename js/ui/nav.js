...
function renderBottomNav({ onNavigate }) {
  ...
  nav.innerHTML = `
    <div style="display:flex;justify-content:center;gap:4px;padding:8px 16px;background:var(--surface);border-radius:20px;margin:8px 16px;position:fixed;bottom:8px;left:50%;transform:translateX(-50%);max-width:448px;width:calc(100% - 32px);z-index:30;">
